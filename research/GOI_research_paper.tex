...
A controlled generative validation on two contrasting ontologies shows
that GOI-prompted generation by construction covers 100\% of applicable
ontology nodes; a generic three-field template recovers 95.7\% on
familiar invoices but collapses to 65.4\% on a custom 63-node hiring
taxonomy. The structural coverage holds regardless of how familiar the
document type is to the model.
