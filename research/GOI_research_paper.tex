...
% Code: https://github.com/cjsergienko/ontology
\author{Sergei Sergienko\inst{1}}
...
cross-functional AI product development. The implementation is open source at \url{https://github.com/cjsergienko/ontology-open};
...
The author thanks the open-source and academic communities whose tools
and datasets made this research possible. The live demo system,
\url{https://ontology.live}, serves as an open resource for the research
community. Video demonstrations of the GOI framework are available on
the \textit{Generative Ontology Induction} YouTube channel
...
The source code, documentation, and example ontologies used in this work
are publicly available at
\url{https://github.com/cjsergienko/ontology-open}.
The live demo is accessible at \url{https://ontology.live}.
...
Wang, T., Shi, D., Aguilar, J., Zurada, J.:
AutoClusRE: An Automatic Clustering-Based Method for Relation Extraction
and Knowledge Graph Construction.
Research Square (Preprint), \doi{10.21203/rs.3.rs-7705090/v1} (2024)
...
Haase, P., Herzig, D.M., Kozlov, A., Nikolov, A., Trame, J.:
metaphactory: A Platform for Knowledge Graph Management.
Semantic Web 10(6) (2019). \doi{10.3233/SW-190360}
