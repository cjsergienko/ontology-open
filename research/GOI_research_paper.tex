...
included. The Job Description Ontology ontology was induced from
...
documentation, and example ontologies are publicly available:

\begin{itemize}[leftmargin=*,nosep]
  \item \textbf{Source repository:} \url{https://github.com/cjsergienko/ontology-open}
  \item \textbf{Live demo:} \url{https://ontology.live}
  \item \textbf{Video demonstrations:} \url{https://www.youtube.com/@GenerativeOntologyInduction}
\end{itemize}
